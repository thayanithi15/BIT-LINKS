  ...
  return (
    <div className="flowchart">
      <Tree
        ...
        label={
          // <div className="node">
          <a1 onClick={() => setPerson(true)} className="a1-flow">
...
"></div>
                    <div className="border-image-container"></div>
                    <div className="icon">
                      <a11 onClick={() => setAlumni(true)} className="a1-flow">
                        <span className="topics-flowchart">
                          {/* <div className="person-border"> */}
                          <div className="person-icon">
                            <svg
...
"></div>
                  <div className="border-image-container"></div>
                  <div className="icon">
                    <a15 onClick={() => setOthers(true)} className="a1-flow">
                      <span className="topics-flowchart">
                        {/* <div className="person-border"> */}
                        <div className="person-icon">
                          <svg
        ...
        <Dialog open={person} onClose={() => setPerson(false)}>
          <div
            ...
            <div id="buttonContainer-flowchart-person">
              ...
              <button color="primary" id="save-flowchart-person">
                Save changes
              </button>
            </div>
          </div>
