...
//     console.log("Date/Time:", value.format("DD/MM/YYYY - HH:mm A"));
...
//     };
//     axios
//       .post("http://localhost:5000/addVisitLog", visitlog)
//       .then((response) => {
//         console.log(response.data);
//         handleClose();
//       })
//       .catch((error) => {
//         console.error("There was an error adding the call log!", error);
//       });
//   };
//   const handleChange = (event) => {
//     setAge(event.target.value);
...
//     axios
//       .post("http://localhost:5000/addCallLog", callLog)
//       .then((response) => {
//         console.log(response.data);
//         handleClose();
//       })
...
//           <p>
//             Call History<i className="fa-solid fa-circle-info"></i>
//           </p>
...
//                 <StepLabel
//                   StepIconComponent={() => (
//                     <CustomStepIcon src={step.icon} className="step-icon" />
//                   )}>
//                   <div className="calll">
...
//             />
//           </div>
//           <div id="buttonContainer-history">
//             <button color="primary" id="discard-history" onClick={handleClose}>
//               Discard
//             </button>
//             <button color="primary" id="save-history" onClick={handleSave}>
//               Save
//             </button>
//           </div>
//         </Dialog>
...
//         <div className="call-main">
//           <p>
//             Visited History<i className="fa-solid fa-circle-info"></i>
//           </p>
//           <div className="call-tags">
